...
You always walk only a single block in a direction and you know it takes you one minute to traverse one city block, so create a 
...
def isValidWalk(walk):
    ...
    if (arr[1] == arr[0] and arr[2] == arr[3]):
        return True 
